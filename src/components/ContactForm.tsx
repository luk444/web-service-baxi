...
const ContactForm = () => {
  ...
  try {
    const response = await fetch("https://formsubmit.co/ajax/oficialbaxiservice@gmail.com", {
      method: "POST",
      headers: {
                ...
                content={
                  <div className="w-full space-y-3">
                    ...
                    <div className="flex flex-col">
                      ...
                      <a href="tel:+5491128462184" className="text-blue-600 hover:text-blue-700 transition-colors">
                        +54 9 11 2846-2184
                      </a>
                    </div>
                  </div>
