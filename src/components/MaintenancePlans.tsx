    ...
    <div className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900">PLANES DE MANTENIMIENTO DE CALDERAS</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <img
              src={mantenimiento}
              alt="Planes de mantenimiento de calderas"
          ...
          <div>
            <h3 className="text-2xl font-bold mb-8">¿Por qué es importante contratar un plan de mantenimiento?</h3>
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold mb-2">Un técnico especializado pondrá a punto tu caldera cada año</h4>
                  <p className="text-gray-600">
                    Dentro de la normativa RITE se recoge que los usuarios deben realizar revisiones periódicas obligatorias de sus equipos térmicos. Todos nuestros planes de mantenimiento incluyen la revisión y puesta a punto del equipo de forma anual por parte de nuestro equipo técnico.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    A medida que los equipos se ensucian, van necesitando cada vez más energía para obtener el mismo rendimiento que un equipo nuevo. Con nuestros planes de mantenimiento nos aseguramos de mantener tu equipo en las mejores condiciones para asegurar un correcto consumo energético.
                  </p>
                </div>
              </div>
